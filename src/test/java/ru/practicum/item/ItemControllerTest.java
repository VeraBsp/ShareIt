...
class ItemControllerTest {
    ...
    void update_shouldReturnUpdatedItem() throws Exception {
        ...
        ItemDto response = new ItemDto(1L, "New name", "desc", true, null);

        when(itemService.update(eq(1L), any(), eq(userId))).thenReturn(response);
        ...
        verify(itemService).update(eq(1L), any(), eq(userId));
    }
