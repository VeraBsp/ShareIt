...
class ItemServiceImplTest {
    ...
    void getById_shouldSetBookingsForOwner() {
        ...
        when(commentRepository.findByItemIdOrderByCreatedDesc(5L))
                .thenReturn(List.of());
        when(bookingRepository.findFirstByItem_IdAndStartBeforeAndStatusOrderByStartDesc(eq(5L), any(LocalDateTime.class), eq(BookingStatus.APPROVED)))
                .thenReturn(Optional.of(last));
        when(bookingRepository.findFirstByItem_IdAndStartAfterAndStatusOrderByStartAsc(eq(5L), any(LocalDateTime.class),
    ...
    void getById_shouldNotSetBookingsForNotOwner() {
        ...
        verify(bookingRepository, never()).findFirstByItem_IdAndStartBeforeAndStatusOrderByStartDesc(any(), any(LocalDateTime.class),
                eq(BookingStatus.APPROVED));
    }
